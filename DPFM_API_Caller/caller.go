...
import (
	"context"
	dpfm_api_input_reader "data-platform-api-purchase-requisition-cancels-rmq-kube/DPFM_API_Input_Reader"
	dpfm_api_output_formatter "data-platform-api-purchase-requisition-cancels-rmq-kube/DPFM_API_Output_Formatter"
	"data-platform-api-purchase-requisition-cancels-rmq-kube/config"
...
func (c *DPFMAPICaller) headerCancel(
	...
	header.IsCancelled = input.PurchaseRequisition.IsCancelled
	...
	for i := range *items {
		(*items)[i].IsCancelled = input.PurchaseRequisition.IsCancelled
